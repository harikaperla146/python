#Graph:   a graph data structure is the collection of node that have data and connected to other nodes 
#example facebook ,instagaram    Every relationship is the edge from one node to another weather u post a photo
#join a group or liking a page etc or  new connection is created for relationship 
#1path 2directed graph
#null graph directed graph none directed 
#WAPP a create a simple graph
class SimpleGraph:
    def __init__(self):
        self.nodes = {}
        self.edges = set()
